...
async def scrape_and_save():
    ...
    async def req(post_id):
        ...
        if response.status_code == 200:
            ...
            await search_collection.insert_many(comments)
...
# Fungsi untuk mengonversi ObjectId menjadi string
            ...
            with open('output_filtered.json', 'w', encoding='utf-8') as f:
                json.dump(convert_objectid_to_str(comments), f, ensure_ascii=False, indent=4)

            print("Data berhasil disimpan ke MongoDB dan file JSON.")
        else:
